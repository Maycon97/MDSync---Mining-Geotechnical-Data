...
export const FieldCollectionTab = ({ preSelectedInstrument, initialSubTab = 'leitura' }) => {
  const { 
    structures, 
    instruments, 
    addReading, 
  ...
  // Hook para foto da leitura de instrumento
  const readingPhoto = useCameraPhoto();

  const [activeSubTab, setActiveSubTab] = useState(initialSubTab || 'leitura'); // 'leitura' | 'anomalia'
  ...
  return (
    <div className="animate-page-enter" style={{ maxWidth: '1280px', width: '100%', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '1.25rem', boxSizing: 'border-box' }}>
